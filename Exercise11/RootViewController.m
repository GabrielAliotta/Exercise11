...
- (void)insertNewObject
{
    ...
    AddBeerViewController *addBeerView = [[AddBeerViewController alloc] initWithNibName:@"AddBeerViewController" bundle:[NSBundle mainBundle]];
    addBeerView.beer = (Beer *) newManagedObject;
